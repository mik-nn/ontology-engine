...
def main(project_root: str = ".") -> GraphStore:
    ...
    stubs = StubDetector(store, project_root).detect_all()
    print(f"  function stubs : {stubs['stubs']}")
    print(f"  todo comments  : {stubs['todos']}")
