---
type: article
title: "The Living Graph: Holons and the Four-Graph ModelБез названия"
source: https://substack.com/@kurtcagle/p-190911279
created: 2026-03-20
tags:
  - article
---
...
Источник: https://substack.com/@kurtcagle/p-190911279
...
![](https://substackcdn.com/image/fetch/$s_!wb4j!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F056a8206-a39a-4407-abd6-bf23b4dbf15b_2688x1536.jpeg)



](https://substackcdn.com/image/fetch/$s_!wb4j!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F056a8206-a39a-4407-abd6-bf23b4dbf15b_2688x1536.jpeg)

_I’ve had a lot of people comment on my holon post, and it’s probably a good time to dig into it in greater depth._

_The world, as you know it, is continuous._

- _You walk through doorways, open up boxes, and store things in safes and warehouses._
    
- _When you get into an aeroplane, you see the airport, then, as the plane takes off, the surrounding city, the region, and, if you go high enough, the whole planet._
    
- _We have become used to zooming in microscopically, and drilling down has become synonymous with digging deeper into a topic._
    
- _When your car breaks down and needs to be serviced, you open up the hood to get to the engine parts,_
    
- _when a surgeon operates on a body, the operation exposes the muscles, veins, nerves, organs, ligaments and bones of that body._
    

_Your mind, on the other hand, can’t hold all of the world within it; nor, despite the best efforts of AGI advocates, can you fit the whole of reality into a computer system. Instead it decomposes complex systems into collections of interconnected containers, limiting the scope of the model so that it can be processed while isolating the extraneous context, creating encapsulation and boundaries._

_This is the world of the Holon. The following article looks at holons at both a conceptual and graph model as a basic primer. It’s a work in progress, and is intended primarily to introduce some of the core aspects of holonic RDF graphs. It is a continuation of ideas first developed in my previous article_

[

## Holons, Boundaries, and Context Graphs: From Koestler to SHACL

](https://ontologist.substack.com/p/holons-boundaries-and-context-graphs)

[Kurt Cagle](https://substack.com/profile/2751178-kurt-cagle)

·

Mar 9

[![Holons, Boundaries, and Context Graphs: From Koestler to SHACL](https://substackcdn.com/image/fetch/$s_!97in!,w_1300,h_650,c_fill,f_auto,q_auto:good,fl_progressive:steep,g_auto/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6ee45c11-94be-4ee2-8d11-42601eda8afd_2688x1536.jpeg)](https://ontologist.substack.com/p/holons-boundaries-and-context-graphs)

Continuing my discussion on context graphs, one of the more vexing questions involved is a core one in systems theory: what is the distinction between an entity and a system? I believe this is a core question when dealing with context graphs, and as such it relates to understanding both the world of Arthur Koestler and one of his most influential theori…
...
_This is tied into the [W3C Context Graph Community Group](https://github.com/W3C-Context-Graph-Community-Group/Semantic-Alignment)._

---

## Preface: A Problem With Flat Graphs

If you have worked with RDF for any length of time, you have probably run into a particular kind of frustration. You start with a clean, elegant graph. A handful of classes, some properties, a set of well-formed triples. Then the requirements arrive: this data is sourced from three different authorities with different confidence levels; this concept exists at multiple scales of resolution; this relationship needs to carry a timestamp and a provenance note; these subgraphs need different access controls; and by the way, the same entity appears in five different contexts that all need to remain coherent with each other.

The standard RDF toolkit — triples, named graphs, a SPARQL endpoint — handles any one of these requirements gracefully. It handles all of them simultaneously with considerably more difficulty. You end up with workarounds: blank nodes that proliferate beyond control, named graphs that have no principled relationship to one another, reification patterns that solve one problem while creating three more.

The deeper issue is that flat RDF has no native concept of _inside_ and _outside_. A triple is just a triple. A named graph is just a bag of triples with a label. There is no principled way to say: these triples constitute a coherent entity with a well-defined boundary, and that boundary governs how the entity relates to everything else in the graph.

This is the problem that holons solve.

---

## Part One: What Is a Holon?

The word was coined by the Hungarian-British writer Arthur Koestler in his 1967 book _The Ghost in the Machine_. Koestler was trying to describe a pattern he saw everywhere in biological and social systems: things that are simultaneously wholes in themselves and parts of something larger.

A cell is a whole — it has a membrane, an interior, a coherent biochemistry, a life cycle. But it is also a part — of a tissue, of an organ, of a body. Remove it from that larger context and it loses meaning. A word is a whole — it has a sound, a spelling, a definition. But it is also a part — of a sentence, of a paragraph, of an argument. Neither characterisation is more fundamental than the other. The cell is not “really” just a component; the body is not “really” just an assembly of cells. Both levels of description are real and necessary.

Koestler called this pattern a **holon** (from the Greek _holos_, whole, plus the suffix _-on_ suggesting a particle, as in proton or neutron). A system of nested holons — cells within tissues within organs within bodies, or words within sentences within paragraphs within documents — he called a **holarchy**.

The pattern has three essential properties:

**Self-consistency.** A holon makes sense on its own terms. Its interior is coherent. It does not require knowledge of the larger system to be understood.

**Relational dependence.** A holon’s meaning is shaped by its position in the holarchy. The same cell behaves differently in a heart than in a liver. The same word means different things in different sentences.

**Dual interface.** A holon has two faces: an _inward face_ that governs its interior coherence, and an _outward face_ that governs how it appears to and interacts with the systems that contain it.

These three properties are not philosophical abstractions. They translate directly into architectural requirements for a knowledge graph system — and the four-graph model is the architecture that satisfies all three.

---

## Part Two: The Cell as Mental Model

Before introducing the four graphs formally, it is worth dwelling on the cell analogy, because it does most of the conceptual work.

[

![](https://substackcdn.com/image/fetch/$s_!Zq5P!,w_2400,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F230049f2-df5b-4b9e-bd3b-9e006d8fd5a2_1344x768.jpeg)



](https://substackcdn.com/image/fetch/$s_!Zq5P!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F230049f2-df5b-4b9e-bd3b-9e006d8fd5a2_1344x768.jpeg)

Picture a living cell under a microscope. It has four distinguishable structural elements:

**The contents** — the organelles, the DNA, the proteins being manufactured, the chemical reactions in progress. Everything that makes this cell _this cell_, described entirely on its own terms.

**The membrane** — the cell wall. Selectively permeable: some things pass through, others do not. Studded with receptor proteins that recognise specific molecules. The membrane is not just a container; it is an active participant in the cell’s identity, deciding what belongs inside and what does not.

**The signals the cell broadcasts** — the hormones, surface proteins, and chemical gradients that tell neighbouring cells what type this cell is, what state it is in, and where it is. The cell does not expose its DNA to the bloodstream. It exposes a carefully curated set of signals that external systems can interpret.

**Its position in the organism** — whether this cell belongs to the liver, the heart, the immune system. This contextual placement does not change what the cell _is_, but it fundamentally shapes what the cell _does_ and what it _means_.

The four-graph model maps these four elements onto a knowledge graph architecture. Each holon in the graph has four named graphs associated with it, each playing one of these roles.
